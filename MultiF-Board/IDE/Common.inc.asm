...
CDISK		EQU	0004H		; byte: Last logged drive (CP/M 2.2 only)
...
RST7SP2		EQU	0039H
RST7SP1		EQU	0038H
VDSKBUF		EQU	RST7SP1-8	; table: 8 bytes command structure buffer
...
;
FDCRESTC	EQU	007H		; 1771 restore (seek to trak 0) cmd
FDCSEEKC	EQU	017H		; seek cmd
FDCREADC	EQU	088H		; read cmd
FDCWRITC	EQU	0A8H		; write cmd
;
; ---------------------------------------------------------------------
