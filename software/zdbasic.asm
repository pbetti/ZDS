...
stack	equ	mbase+$200	; STACK TOP        (3010-30FF)
sysvar	equ	mbase+$200	; SYSTEM VAR SPACE (3100-31FF)
inbuff	equ	mbase+$260	; INPUT  BUFFER    (3160-31AF)
buffer	equ	mbase+$2b0	; CRUNCH BUFFER    (31b0-31FF)

basicv	equ	mbase+$300	; BASIC  VAR SPACE (3200-32FF)
ltext	equ	mbase+$400	; BASIC PROGRAM    (3300-FFFF)
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
wrkspc	equ	basicv		; Initially $3200
...
init	ld	hl,initab	; Source=Init table
	...
	ld	de,ltext+$374	; PROGST + 100 BYTES
...
signon	defb	$0c,"Z80 BASIC Version 5.0",CR,LF
	defb	"Z80 DarkStar"
	defb	" system by P.Betti <pbetti@lpconsul.eu>",CR,LF,0,0
...
tnoram	defb	"No external RAM"
	defb	" detected above $3000",CR,LF,0,0
