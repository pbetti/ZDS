...
void 
b_getcur (int *line_ptr, int *pos_ptr)
#else
...
void 
b_getmark (int *line_ptr, int *pos_ptr)
#else
...
static void 
add_rec (int type, int line, char *del_text)
#else
