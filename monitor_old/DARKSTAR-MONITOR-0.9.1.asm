...
MENAPRT		EQU	$21
; -- Map --
EEPSTA		EQU	$F000		; eeprom location after MMU reset
MMTPAPAG	EQU	(EEPSTA>>8)-1	; TPA top page (256 bytes pages)
;
; MMU organization
;
; MMU manage 16 4kb pages in Z80 address space (physical)
; It can assign any of 256 4k pages (logical) from its
; 1Mb address space.
;
...
;
	...
	ORG	EEPSTA		; THIS IS MONITOR EPROM BASE, (de)comment when you need to test
