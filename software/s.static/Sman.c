...
can_scroll (
    ...
    int new_first	/* number of the line currently at new_row1 */
)
#else
...
static void 
chop_arg (void (*fcn)(void), char *arg, int maxlen)
#else
...
static void 
chop_cpy (char *s, char *t, int maxlen)
#else
...
static void 
displ_text (int row, int line_id, int nsegs, char *s)
#else
...
static int 
expand (char *s, char *t, int maxchars)
#else
...
static void 
ins_text (int row, int lineid, int nsegs, char *t)
#else
...
static void 
pos_to_seg (char *t, int pos, int *seg_ptr, int *col_ptr)
#else
...
static void 
replace (int row, int line, int useful_row)
#else
...
repl_text (
    ...
    int line_id,	/* ID of the new line */
    int new_segs,	/* number of segments in the new line */
    int useful_row,	/* next row that should not be overwritten */
...
row_of_id (
    ...
    int row	/* first row to be searched */
)
#else
