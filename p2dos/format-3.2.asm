...
DFTAB:	;DEFB	40,1,18,0		; 40 TRK SS	; 40 tracks formats
	...
	DEFB	80,2,11,1		; 80 TRK DS 256 bytes 10 sec.
	DEFB	80,2,7,2		; 80 TRK DS 512 bytes 6 sec.
	;
	;
...
MCHO2:	DEFB	CR,LF
	...
	DEFB	"2 - 80 TRACK, 256 bytes, 10 sectors/track, DS",CR,LF
	DEFB	"3 - 80 TRACK, 512 bytes,  6 sectors/track, DS",CR,LF
	DEFB	CR,LF
	DEFB	"SELECT 1-3 :"
	DEFB	$00
