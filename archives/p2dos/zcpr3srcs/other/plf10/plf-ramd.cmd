...
P2 $zzif;reg s0 6; p3 $1 $'FILE(S) TO TYPE/EXTRACT/PRINT: ';zif
...
P9 $zzif;echo ^M^J* p%>lease wait *;reg s1 0;if eq $.2 m?c;s p mac;reg p1;else;if eq $.2 d?c;s p doc;reg p1;zif; p10 $*;zif
P10 $zzif;if eq $.2 zzz;s p  ;reg p1;else;if eq $.2 u?d;s p upd;reg p1;else;if eq $.2 z?0;s p z80;reg p1;else;if eq $.2 i?f;s p inf;reg p1;zif; p11 $*;zif
P11 $zzif;if eq $.2 n?t;s p not;reg p1;else;if eq $.2 l?b;s p lib;reg p1;else;if eq $.2 h?s;s p his;reg p1;else;if eq $.2 m?g;s p msg;reg p1;zif; p12 $*;zif
P12 $zzif;if reg 1=0;s p * i;fi;rs print $:2.%p$$|era $:2.%p;if ~nu $:3; P8 $1 $-2;else;llf $1; p2 $1;zif
